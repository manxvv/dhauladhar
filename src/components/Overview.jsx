    ...
    <Layout>
          ...
          <div>
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-emerald-700">Prime Location</span>
              </div>
              <div className="flex items-center space-x-3">
                <Mountain className="text-emerald-600" />
                <span className="text-emerald-700">Scenic Views</span>
              </div>
              <div className="flex items-center space-x-3">
                <Leaf className="text-emerald-600" />
                <span className="text-emerald-700">Natural Living</span>
              </div>
            </div>
          </div>
      ...
      <section className="w-full">
        <div className="container mx-auto p-4">
          <h2 className="text-3xl font-bold text-emerald-800 text-center mb-8">Location Highlights</h2>
        </div>
        <iframe
