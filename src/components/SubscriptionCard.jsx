  ...
  return (
    <div className="mt-5 py-12 px-4">
      <div className="max-w-5xl mx-auto">
        ...
        <h2 className="text-xl sm:text-2xl font-bold text-center text-emerald-800">
        Premium Tiers: 
        </h2>
                            <h3 className="text-2xl sm:text-3xl font-bold text-center text-emerald-600 mb-6">
                            Unlocking Advanced Career Development                            </h3>

        {/* Cards */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Pro Tier */}
          <div className="bg-white shadow-lg rounded-xl p-6 border-2 border-emerald-500 hover:shadow-2xl transition duration-300">
            <h3 className="text-xl font-semibold text-emerald-600 mb-4">Pro Tier</h3>
            <p className="text-emerald-700 text-lg font-bold mb-2">$20/month</p>
            <p className="text-emerald-500 mb-4">(21 Sessions)</p>
            ...
            <button className="mt-6 w-full py-2 bg-emerald-500 text-white rounded-md font-medium hover:bg-emerald-600">
              Choose Pro
            </button>
          </div>
          ...
          <div className="bg-white shadow-lg rounded-xl p-6 border-2 border-purple-500 hover:shadow-2xl transition duration-300">
            ...
            <p className="text-emerald-700 text-lg font-bold mb-2">$50/month</p>
            <p className="text-emerald-500 mb-4">(21 Sessions)</p>
            <ul className="text-emerald-700 space-y-2">
        ...
        {/* ROI Section */}
        {/* <div className="bg-emerald-50 mt-10 p-6 rounded-xl shadow-md">
          <h3 className="text-2xl font-semibold text-emerald-800 mb-4">ROI for Users</h3>
          <ul className="text-emerald-700 space-y-2">
