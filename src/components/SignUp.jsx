    ...
    <div className="flex items-center justify-center min-h-screen bg-emerald-100">
      <div className="w-full max-w-lg p-8 bg-white shadow-md rounded-md">
        ...
        <form onSubmit={handleSubmit(data => signUpMutation.mutate(data))} className="mt-6">
          {/* Name */}
          <div className="mb-4">
            <label className="block mb-1 text-emerald-700">Name</label>
            <input
              type="text"
              {...register("name", { required: "Name is required" })}
              placeholder="Enter your name"
              className={`w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-emerald-400 ${errors.name ? "border-red-500" : "border-emerald-300"
                }`}
            />
            {errors.name && (
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className={`w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-emerald-400 ${errors.email ? "border-red-500" : "border-emerald-300"
                }`}
            />
            {errors.email && (
          ...
          {/* Phone Number */}
          <div className="mb-4">
            <label className="block mb-1 text-emerald-700">Password</label>
            <input
              type="password"
              {...register("password", { required: "Password is required" })}
              placeholder="Enter your password"
              className={`w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-emerald-400 ${errors.password ? "border-red-500" : "border-emerald-300"
                }`}
            />
            {errors.password && (
